...
def build_kiro_headers(token: str) -> dict:
    ...
    return {
        ...
        "x-amz-user-agent": f"aws-sdk-js/1.0.27 KiroIDE-0.10.0-{MACHINE_ID}",
        "user-agent": f"aws-sdk-js/1.0.27 ua/2.1 os/linux lang/js md/nodejs api/codewhispererstreaming KiroIDE-0.10.0-{MACHINE_ID}",
